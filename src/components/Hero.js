        ...
        <div className="banner-text">
          {[...Array(30)].map((_, index) => (
            <React.Fragment key={index}>
              <span className="emily">Emily</span> <span className="sepulveda">Sepúlveda</span>
            </React.Fragment>
          ))}
        </div>
      </div>

      {/* Profile debajo del banner */}
      <div className="profile" id="sobre-mi">
        <img src="images/placeholder.jpeg" alt="Profile" className="profile-img" />
        ...
        <button className="button">
          ...
          <span className="text_button">Contactame</span>
        </button>
